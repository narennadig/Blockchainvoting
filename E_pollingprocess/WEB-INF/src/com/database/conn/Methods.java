...
/* METHOD FOR CHECK VOTER ID IN DATABASE */
	...
	{	
	//	ResultSet rs1=null;
		System.out.println("===============Jothi1=====location============" + location);
		try
		{
			int district_code = 0;
			con=DBConnection.getServerConnection();
			...
			String sql = "select C_symbol,C_name,C_code from m_candidate where E_D_code='"+district_code+"'";
			System.out.println("===========jothi=====sql============="+sql);
