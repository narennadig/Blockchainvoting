...
public class Paillier 
{
	...
	*/
	public BigInteger Encryption(BigInteger m)
	{
		...
		System.out.println("    value  :"+r.modPow(n, nsquare));
		return g.modPow(m, nsquare).multiply(r.modPow(n, nsquare)).mod(nsquare);
	...
	*/
	...
	/* instantiating an object of Paillier cryptosystem*/
		...
		System.out.println("Encrypt 1st value :"+em1);
		System.out.println("Encrypt 2nd value :"+em2);
		/* printout decrypted text */
	//	System.out.println("Decrypt 1st value :"+paillier.Decryption(em1).toString());
	//	System.out.println("Decrypt 2nd value :"+paillier.Decryption(em2).toString());
