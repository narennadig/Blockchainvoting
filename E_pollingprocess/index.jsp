...
<br><br>
<form action="Voters.jsp" method="post">
<table style="font-family: cambria; font-weight: bold;">
	<tr>
		<td><b>VOTER ID</b></td>
		<td>&emsp;:&emsp;</td>
		<td><input type="text" name="voter_id" required ></input></td>
		
	</tr>
</table>
<td>&emsp;&emsp;</td>
<center>&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;<a href="Voters.jsp"><button>Enter the vote</button></a></center>
</form>
<br>
